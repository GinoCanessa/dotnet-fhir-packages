...
public class PackageDirectiveTests
{
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.us.core");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.r4#4.0.1");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.us.core#current");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.us.core#current$R5");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.us.core#dev");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("v610@npm:hl7.fhir.us.core@6.1.0");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.r4.core#4.0.x");
    ...
    {
        Func<PackageDirective> act = () => PackageDirective.Parse("");
    ...
    {
        Func<PackageDirective> act = () => PackageDirective.Parse(null!);
    ...
    {
        string input = "hl7.fhir.r4.core#4.0.1";
        PackageDirective directive = PackageDirective.Parse(input);
    ...
    public void ToReference_ProducesCorrectReference()
    {
        ...
        PackageReference reference = directive.ToReference();
    ...
    {
        PackageDirective directive = PackageDirective.Parse("hl7.fhir.us.core#6.1.0");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("some.third.party.package#1.0.0");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("@scope/name@1.0.0");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("myalias@npm:hl7.fhir.r4.core@4.0.1");
    ...
    {
        PackageDirective directive = PackageDirective.Parse("name@@");
